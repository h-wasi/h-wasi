...
[![My Skills](https://skillicons.dev/icons?i=react,nextjs,docker,kubernetes,aws,tailwind,express,go,postgresql,nodejs,mongodb,bash,linux,js,ts,redux)](https://skillicons.dev)
