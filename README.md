...
[![My Skills](https://skillicons.dev/icons?i=react,nextjs,docker,kubernetes,aws,tailwind,express,nodejs,firebase,supabase,mongodb,bash,linux,js,ts,appwrite,redux)](https://skillicons.dev)
