...
[![My Skills](https://skillicons.dev/icons?i=react,nextjs,docker,kubernetes,aws,tailwind,express,motion,nodejs,firebase,supabase,mongodb,bash,linux,js,ts,redux,appwrite)](https://skillicons.dev)
